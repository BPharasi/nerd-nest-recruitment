...
const NotificationsPage: NextPage = () => {
  ...
  useEffect(() => {
    // Load notifications from localStorage, with fallback to mock data
          ...
          <div className="space-y-4">
            {filteredNotifications.length === 0 ? (
              <div className="text-center py-12">
                <FaBell className="mx-auto text-teal-100 text-4xl mb-4" />
                <p className="text-teal-50 text-lg">No notifications found</p>
              </div>
            ) : (
              filteredNotifications.map((notif) => (
                <div
                  ...
                  className={`rounded-xl shadow-lg border-l-4 ${getNotificationBorderColor(notif.type)} ${
                    !notif.read ? 'bg-teal-400/10' : ''
                  }`}
                >
                  <div className="p-6">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-teal-50 mb-3">{notif.message}</p>
